...
?>
    <div id="wide-nav" class="header-bottom wide-nav <?php header_inner_class('bottom'); ?>">
        <div class="flex-row container menu-bottom-row">
            <?php if (get_theme_mod('header_elements_bottom_left') || get_theme_mod('header_elements_bottom_right')) { ?>
                <div class="flex-col hide-for-medium flex-left menu-bottom-row__nav-wrap">
                    <ul class="menu-bottom-row__nav nav header-nav header-bottom-nav nav-left <?php flatsome_nav_classes('bottom'); ?>">
