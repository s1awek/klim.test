...
<div id="fupi_offscreen">
    ...
    <button type="button" id="fupi_offscreen_maximize_btn"><span class="dashicons dashicons-fullscreen-alt"></span><span class="dashicons dashicons-fullscreen-exit-alt"></span></button>
