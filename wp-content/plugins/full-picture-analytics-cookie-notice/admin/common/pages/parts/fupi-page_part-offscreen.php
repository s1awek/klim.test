...
<div id="fupi_offscreen">
    ...
    <div id="fupi_offscreen_content_wrap">
        ...
        <div id="fupi_offscreen_nav">
            <button type="button" id="fupi_offscreen_prev_btn" class="button-secondary fupi_open_popup fupi_popup_nav_btn fupi_disabled" data-type="prev" data-popup=""><span class="dashicons dashicons-arrow-left-alt2"></span> <?php esc_html_e('Previous', 'full-picture-analytics-cookie-notice'); ?></button>
