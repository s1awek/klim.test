...
class Fupi_MATO_public {
    ...
    public function enqueue_scripts(){
        ...
        /* ^ */ wp_enqueue_script( 'fupi-mato-head-js', FUPI_URL . 'public/modules/mato/fupi-mato.js', array( 'fupi-helpers-js' ), FUPI_VERSION, [ 'in_footer' => false, 'strategy' => 'async' ] );
        /* _ */ wp_enqueue_script( 'fupi-mato-footer-js', FUPI_URL . 'public/modules/mato/fupi-mato-footer.js', $reqs, FUPI_VERSION, [ 'in_footer' => true, 'strategy' => 'async' ] );
    }
}