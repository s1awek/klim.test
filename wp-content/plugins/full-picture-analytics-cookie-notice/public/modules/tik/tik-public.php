...
class Fupi_TIK_public {
    ...
    public function enqueue_scripts(){
        ...
        /* ^ */ wp_enqueue_script( 'fupi-tik-head-js', FUPI_URL . 'public/modules/tik/fupi-tik.js', array( 'fupi-helpers-js' ), FUPI_VERSION, [ 'in_footer' => false, 'strategy' => 'async' ] );
        /* _ */ wp_enqueue_script( 'fupi-tik-footer-js', FUPI_URL . 'public/modules/tik/fupi-tik-footer.js', $reqs, FUPI_VERSION, [ 'in_footer' => true, 'strategy' => 'async' ] );
    }
}