function fupi_linkd_woo_footer(){
	...
	FP.loaded('linkd_footer_woo');
}

function fupi_linkd_footer(){
...
function fupi_linkd(){
	...
	function mark_as_loaded(){
		FP.loaded('linkd','linkd','[FP] LinkedIn loaded');
	}
	...
	function load_linkd() {
		...
		FP.getScript("https://snap.licdn.com/li.lms-analytics/insight.min.js", mark_as_loaded, {'async' : 'async'})
	}
};

FP.load('linkd','fupi_linkd',['head_helpers']);
FP.load('linkd_footer','fupi_linkd_footer',['linkd','footer_helpers']);
FP.load('linkd_footer_woo','fupi_linkd_woo_footer',['linkd','woo','footer_helpers']);