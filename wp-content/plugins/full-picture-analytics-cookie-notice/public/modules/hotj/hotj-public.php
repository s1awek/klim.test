...
class Fupi_HOTJ_public {
    ...
    public function enqueue_scripts(){
        ...
        /* ^ */ wp_enqueue_script( 'fupi-hotj-head-js', FUPI_URL . 'public/modules/hotj/fupi-hotj.js', array( 'fupi-helpers-js' ), FUPI_VERSION, [ 'in_footer' => false, 'strategy' => 'async' ] );
        /* _ */ wp_enqueue_script( 'fupi-hotj-footer-js', FUPI_URL . 'public/modules/hotj/fupi-hotj-footer.js', $reqs, FUPI_VERSION, [ 'in_footer' => true, 'strategy' => 'async' ] );
    }
}