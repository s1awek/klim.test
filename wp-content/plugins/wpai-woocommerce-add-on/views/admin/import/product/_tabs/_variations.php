<div class="panel woocommerce_options_panel" id="variable_product_options" style="display:none;">
	<?php if (class_exists('PMWI_Plugin') && PMWI_EDITION == 'free'): ?>
        <div class="woo-add-on-free-edition-notice upgrade_template">
			...
			<?php else: ?>
                <a href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=5839961&discount=welcome-upgrade-169&edd_options%5Bprice_id%5D=1" target="_blank" class="upgrade_woo_link"><?php _e('Upgrade to the WooCommerce Import Package to Import to Variable, Affiliate, and Grouped Products', 'wpai_woocommerce_addon_plugin');?></a>
			<?php endif; ?>
	...
	<div class="options_group" style="padding-bottom:0px;">
		...
		<div class="switcher-target-auto_matching_parent"  style="padding-left:25px;">									
			...
			<p class="form-field">
				<strong><?php _e("Example Data For Use With This Option",'wpai_woocommerce_addon_plugin');?> </strong> - <a href="https://www.wpallimport.com/wp-content/uploads/2014/10/data-example-1.csv" target="_blank"><?php _e("download",'wpai_woocommerce_addon_plugin');?></a>
		...
		<div class="switcher-target-auto_matching_parent_first_is_parent_id"  style="padding-left:25px;">									
			...
			<p class="form-field">
				<strong><?php _e("Example Data For Use With This Option",'wpai_woocommerce_addon_plugin');?> </strong> - <a href="https://www.wpallimport.com/wp-content/uploads/2014/10/data-example-2.csv" target="_blank"><?php _e("download",'wpai_woocommerce_addon_plugin');?></a>
				<span class="wpallimport-clear"></span>
		...
		<div class="switcher-target-auto_matching_parent_first_is_parent_title"  style="padding-left:25px;">
			<p class="form-field">
				<label style="width:auto; margin-right: 10px !important; padding-top: 3px;"><?php _e("Product Title", 'wpai_woocommerce_addon_plugin'); ?></label>
			...
			<p class="form-field">
				<strong><?php _e("Example Data For Use With This Option",'wpai_woocommerce_addon_plugin');?> </strong> - <a href="https://www.wpallimport.com/wp-content/uploads/2014/10/data-example-3.csv" target="_blank"><?php _e("download",'wpai_woocommerce_addon_plugin');?></a>
				<span class="wpallimport-clear"></span>
		...
		<div class="switcher-target-auto_matching_parent_first_is_variation"  style="padding-left:25px;">
			...
			<p class="form-field">
				<strong><?php _e("Example Data For Use With This Option",'wpai_woocommerce_addon_plugin');?> </strong> - <a href="https://www.wpallimport.com/wp-content/uploads/2014/10/data-example-4.csv" target="_blank"><?php _e("download",'wpai_woocommerce_addon_plugin');?></a>
				<span class="wpallimport-clear"></span>
		...
		<div class="switcher-target-xml_matching_parent" style="padding-left:25px; position:relative;">
			...
			<div class="input">
				...
				<p class="form-field"><a href="https://youtu.be/F1NX4po0dsc" target="_blank"><?php _e("Video Example", 'wpai_woocommerce_addon_plugin');?></a></p>
				...
				<div style="margin-right:2%;">
					...
					<div class="options_group">
						<p class="form-field">
							...
							<span class="use_parent align">
								...
								<label style="width: auto; margin: 0 !important;" for="variable_sku_add_parent"><?php _e("Add value to the parent SKU",'wpai_woocommerce_addon_plugin'); ?></label>
								<a href="#help" class="wpallimport-help" title="<?php _e('Enable this checkbox to combine SKU from parent and variation products.', 'wpai_woocommerce_addon_plugin') ?>" style="margin-left: 5px; top:0;">?</a>
							</span>
						</p>
                        <p class="form-field">
                            <label style="width:150px;"><?php _e('GTIN, UPC, EAN or ISBN','wpai_woocommerce_addon_plugin');?></label>
                            <a href="#help" class="wpallimport-help" title="<?php _e('WooCommerce only allows numbers and hyphens in this field.', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:0px;">?</a>
                        ...
                        <p class="form-field" style="margin-top: 5px;">
							...
							<span class="use_parent align">
								...
								<label for="variable_image_use_parent" style="width: auto; margin: 0 !important;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
								<a href="#help" class="wpallimport-help" title="<?php _e('Images are imported according to the options set in the Images section below. There you can import images to the parent products, and here you can import images to the product variations.', 'wpai_woocommerce_addon_plugin') ?>" style="margin-left: 5px; top:0;">?</a>
							</span>
						</p>
						<p class="form-field" style="margin-top: 5px; margin-bottom:10px">
							...
							<span class="use_parent align">
								...
								<label for="variable_description_use_parent" style="width: auto; margin: 0 !important;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
							</span>
						</p>
					</div>
							...
							<div class="switcher-target-is_variable_product_manage_stock_xpath set_with_xpath" style="width:425px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<span class="use_parent" style="top: 2px; left: 10px;">
										...
										<label for="single_variable_product_manage_stock_use_parent" style="top:3px; width: auto;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
                                        <a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one of the following: (\'yes\', \'no\').', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:0;">?</a>
									</span>
								</span>																							
							</div>						
						</div>
					...
					<div class="options_group variable_stock_fields">
						<p class="form-field">
							<label style="width:auto;margin-right:10px !important;"><?php _e('Stock Qty', 'wpai_woocommerce_addon_plugin');?></label>
							...
							<span class="use_parent align">
								...
								<label for="variable_stock_use_parent" style="width: auto; margin: 0 !important;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
							...
							<div class="switcher-target-is_variable_product_virtual_xpath set_with_xpath" style="width:425px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<span class="use_parent" style="top: 2px; left: 10px;">
										...
										<label for="single_variable_product_virtual_use_parent" style="top:3px; width: auto;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
                                        <a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one of the following: (\'yes\', \'no\').', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:0; ">?</a>
									</span>
								</span>																							
							</div>
							...
							<div class="switcher-target-multiple_variable_product_shipping_class_no set_with_xpath">						
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<span class="use_parent">
										...
										<label for="single_variable_product_shipping_class_use_parent" style="top:2px; position: relative; width: auto;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
                                        <a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one of the following: (\'taxable\', \'shipping\', \'none\').', 'wpai_woocommerce_addon_plugin') ?>" style="position: relative; top: 2px; ">?</a>
									</span>																					
								</span>																					
							</div>							
						</div>	
							...
							<div class="switcher-target-multiple_variable_product_tax_class_no set_with_xpath">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<span class="use_parent">
										...
										<label for="single_variable_product_tax_class_use_parent" style="top:1px; position: relative; width: auto;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
                                        <a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one of the following: (\'reduced-rate\', \'zero-rate\').', 'wpai_woocommerce_addon_plugin') ?>" style="position: relative; top:2px;">?</a>
									</span>
								</span>															
							</div>
						</div>								
							...
							<div class="switcher-target-is_variable_product_downloadable_xpath set_with_xpath" style="width:425px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<span class="use_parent" style="left: 10px; top: 2px;">
										...
										<label for="single_variable_product_downloadable_use_parent" style="top:3px; width: auto;"><?php _e("XPath Is From Parent",'wpai_woocommerce_addon_plugin'); ?></label>
							...
							<table id="variation_attributes_table" class="form-table custom-params" style="max-width:95%;">
								...
								<tbody>
									...
									<tr class="wpallimport-table-actions">
										<td colspan="3"><a href="#add" title="<?php _e('add', 'wpai_woocommerce_addon_plugin')?>" class="action add-new-custom"><?php _e('Add Attribute', 'wpai_woocommerce_addon_plugin') ?></a></td>
									</tr>
								</tbody>
							</table>
						</div>
        ...
        <p class="form-field wpallimport-radio-field">
            ...
            <label for="add_variation_to_existing_product" style="width:350px;"><?php _e('I\'m importing new variations to existing products', 'wpai_woocommerce_addon_plugin' )?> </label>
        </p>
        <div class="switcher-target-add_variation_to_existing_product"  style="padding-left:25px;">
            <p class="form-field wpallimport-radio-field">
                <label style="width: 180px;"><?php _e('Manual Parent Product Matching', 'wpai_woocommerce_addon_plugin' )?></label>
                <a href="#help" class="wpallimport-help" style="top: 2px;" title="<?php _e('Variation will be assigned as the child of an already created product matching the specified criteria.', 'wpai_woocommerce_addon_plugin'); ?>">?</a>
            </p>
            <div class="form-field wpallimport-radio-field">
                ...
                <label for="existing_parent_product_matching_logic_cf"><?php _e('Match by Custom Field', 'wpai_woocommerce_addon_plugin' )?></label><br>
                <span class="wpallimport-clear"></span>
            ...
            <div class="form-field wpallimport-radio-field">
                ...
                <label for="existing_parent_product_matching_logic_title"><?php _e('Match Parent by Title', 'wpai_woocommerce_addon_plugin' )?></label>
                <span class="wpallimport-clear"></span>
            ...
            <p class="form-field wpallimport-radio-field">
                ...
                <label for="create_new_product_if_no_parent" style="width:340px;"><?php _e('Create new product if no existing product is found.', 'wpai_woocommerce_addon_plugin') ?></label>
            </p>
        </div>
        <?php endif; ?>
	...
	<div class="options_group">
		...
		<p class="form-field wpallimport-radio-field">
			...
			<label for="set_default_yes" style="width: auto;"><?php _e("Set the default selection in the attributes dropdowns.", 'wpai_woocommerce_addon_plugin'); ?></label>
		...
		<div class="switcher-target-set_default_yes set_with_xpath" style="padding-left:17px;">
            ...
            <div class="form-field wpallimport-radio-field">
                ...
                <label for="set_default_xpath"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin' )?></label>
                <span class="wpallimport-clear"></span>
                <div class="switcher-target-set_default_xpath set_with_xpath">
                    <span class="wpallimport-slide-content" style="padding-left:0;">
                        ...
                        <a href="#help" class="wpallimport-help" title="<?php _e('The value of presented XPath should be one serialized data: a:2:{s:7:”pa_size”;s:3:”6-5″;s:8:”pa_color”;s:3:”red”;}.', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:2px;">?</a>
                    </span>
                </div>
            </div>
		</div>
		...
		<p class="form-field wpallimport-radio-field set_parent_stock_option" style="display:none;">
			...
			<label for="set_parent_stock" style="width: auto;"><?php _e('Set _stock value for parent product to the _stock value for the first variation.', 'wpai_woocommerce_addon_plugin') ?></label>
