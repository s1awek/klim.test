			...
			<thead>
				<tr>
					...
					<td>
						...
						<a href="#help" class="wpallimport-help" title="<?php _e('Separate multiple values with a |', 'wpai_woocommerce_addon_plugin') ?>" style="top:-2px;">?</a>
					</td>
					<td></td>
				</tr>
			</thead>
						...
						<tr class="form-field">
							...
							<td style="width: 50%;">
								...
								<div class="form-field wpallimport-radio-field" style="padding: 0 !important; position: relative; left: -100%; width: 200%;">
									...
									<a href="javascript:void(0);" id="advanced_attributes_<?php echo $i; ?>" class="action advanced_attributes"><?php _e('Advanced', 'wpai_woocommerce_addon_plugin') ?></a>
				...
				<tr class="form-field">
					...
					<td style="width: 50%;">
						...
						<div class="form-field wpallimport-radio-field" style="padding: 0 !important; position: relative; left: -100%; width: 200%;">
							...
							<a href="javascript:void(0);" id="advanced_attributes_0" class="action advanced_attributes"><?php _e('Advanced', 'wpai_woocommerce_addon_plugin') ?></a>
