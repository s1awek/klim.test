...
namespace OmnibusProVendor\Psr\Log\Test;

use OmnibusProVendor\Psr\Log\LoggerInterface;
use OmnibusProVendor\Psr\Log\LogLevel;
use OmnibusProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('OmnibusProVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('OmnibusProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('OmnibusProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
