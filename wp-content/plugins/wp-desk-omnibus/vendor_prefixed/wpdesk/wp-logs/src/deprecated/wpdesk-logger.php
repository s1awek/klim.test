...
if (!\class_exists('OmnibusProVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \OmnibusProVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'wpdesk-omnibus'), 'emergency' => \__('Emergency', 'wpdesk-omnibus'), 'alert' => \__('Alert', 'wpdesk-omnibus'), 'critical' => \__('Critical', 'wpdesk-omnibus'), 'error' => \__('Error', 'wpdesk-omnibus'), 'warning' => \__('Warning', 'wpdesk-omnibus'), 'notice' => \__('Notice', 'wpdesk-omnibus'), 'info' => \__('Info', 'wpdesk-omnibus'), 'debug' => \__('Debug', 'wpdesk-omnibus')];
        }
        /**
         * @param string $level
         * @param string $source
