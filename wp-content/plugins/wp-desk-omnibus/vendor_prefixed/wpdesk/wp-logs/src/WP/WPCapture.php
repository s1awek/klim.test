...
namespace OmnibusProVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \OmnibusProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'wpdesk-omnibus'),
            $dir
        ), \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \OmnibusProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'wpdesk-omnibus'),
            $file
        ), \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
