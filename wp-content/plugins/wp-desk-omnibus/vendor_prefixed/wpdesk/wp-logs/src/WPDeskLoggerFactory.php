...
use LogicException;
use OmnibusProVendor\Monolog\Handler\NullHandler;
use OmnibusProVendor\Monolog\Logger;
use OmnibusProVendor\Monolog\Registry;
use OmnibusProVendor\Monolog\Handler\StreamHandler;
use OmnibusProVendor\Psr\Log\LogLevel;
use OmnibusProVendor\WPDesk\Logger\WC\WooCommerceCapture;
use OmnibusProVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('OmnibusProVendor\WC_LOG_THRESHOLD')) {
            define('OmnibusProVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
