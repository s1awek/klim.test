...
namespace OmnibusProVendor\DI\Compiler;

use function chmod;
use OmnibusProVendor\DI\Definition\ArrayDefinition;
use OmnibusProVendor\DI\Definition\DecoratorDefinition;
...
use OmnibusProVendor\DI\Definition\Source\DefinitionSource;
use OmnibusProVendor\DI\Definition\StringDefinition;
use OmnibusProVendor\DI\Definition\ValueDefinition;
use OmnibusProVendor\DI\DependencyException;
use OmnibusProVendor\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use OmnibusProVendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
