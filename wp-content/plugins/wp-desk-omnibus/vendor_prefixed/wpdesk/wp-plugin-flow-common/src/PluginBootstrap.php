...
namespace OmnibusProVendor\WPDesk\Plugin\Flow;

use OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'wpdesk-omnibus';
     ...
     */
    private function init_translations(\OmnibusProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \OmnibusProVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \OmnibusProVendor\WPDesk_Plugin_Info();
