...
namespace OmnibusProVendor\WPDesk\Plugin\Flow\Initialization;
...
use OmnibusProVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\OmnibusProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\OmnibusProVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
