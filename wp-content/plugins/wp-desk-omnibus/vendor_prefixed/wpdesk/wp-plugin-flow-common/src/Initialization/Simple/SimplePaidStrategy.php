...
namespace OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use OmnibusProVendor\WPDesk\Helper\HelperRemover;
use OmnibusProVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use OmnibusProVendor\WPDesk\License\PluginRegistrator;
use OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use OmnibusProVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use OmnibusProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use OmnibusProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\OmnibusProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\OmnibusProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
