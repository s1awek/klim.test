...
namespace OmnibusProVendor\WPDesk\PluginBuilder\Builder;
...
use OmnibusProVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\OmnibusProVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
