...
<h2><?php 
\printf(\esc_html__('You are deactivating %s plugin.', 'wpdesk-omnibus'), \esc_html($plugin_name));
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\esc_html_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'wpdesk-omnibus');
?></strong></h4>
			<ul id="reasons-list">
				<li class="reason">
					<label>
					<span>
						...
						<span><?php 
\esc_html_e('The plugin suddenly stopped working', 'wpdesk-omnibus');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('The plugin broke my site', 'wpdesk-omnibus');
?></span>
					</label>
				</li>
...
?>">
				...
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I only needed the plugin for a short period', 'wpdesk-omnibus');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('I no longer need the plugin', 'wpdesk-omnibus');
?></span>
					</label>
				</li>
				<li class="reason">
					...
					<span>
						...
						<span><?php 
\esc_html_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'wpdesk-omnibus');
?></span>
					</label>
				</li>
				<li class="reason has-input">
					...
					<span>
						...
						<span><?php 
\esc_html_e('Other', 'wpdesk-omnibus');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\esc_attr_e('Kindly tell us the reason so we can improve', 'wpdesk-omnibus');
?>">
					</div>
				</li>
			</ul>
...
\esc_html_e('Cancel', 'wpdesk-omnibus');
?></a>
		<a href="#" class="button button-primary button-deactivate allow-deactivate"><?php 
\esc_html_e('Skip &amp; Deactivate', 'wpdesk-omnibus');
?></a>
	</div>
</div>
...
\esc_html_e("Submit &amp; Deactivate", "wpdesk-omnibus");
?>' );
	})
