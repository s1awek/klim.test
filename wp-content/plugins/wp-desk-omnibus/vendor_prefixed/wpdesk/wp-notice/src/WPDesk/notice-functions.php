...
if (!\function_exists('OmnibusProVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \OmnibusProVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('OmnibusProVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('OmnibusProVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('OmnibusProVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('OmnibusProVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('OmnibusProVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::notice($noticeContent, \OmnibusProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('OmnibusProVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \OmnibusProVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('OmnibusProVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
