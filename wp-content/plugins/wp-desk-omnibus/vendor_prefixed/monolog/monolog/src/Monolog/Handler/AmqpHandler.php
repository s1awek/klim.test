...
use OmnibusProVendor\Monolog\Formatter\JsonFormatter;
use OmnibusProVendor\PhpAmqpLib\Message\AMQPMessage;
use OmnibusProVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
