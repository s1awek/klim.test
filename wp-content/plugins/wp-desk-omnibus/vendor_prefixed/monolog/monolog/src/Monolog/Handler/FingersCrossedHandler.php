...
use OmnibusProVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use OmnibusProVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use OmnibusProVendor\Monolog\Logger;
use OmnibusProVendor\Monolog\ResettableInterface;
