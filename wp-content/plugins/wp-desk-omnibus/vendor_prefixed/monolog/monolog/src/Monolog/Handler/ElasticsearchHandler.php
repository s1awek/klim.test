...
use OmnibusProVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use OmnibusProVendor\Monolog\Logger;
use OmnibusProVendor\Monolog\Formatter\FormatterInterface;
use OmnibusProVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use OmnibusProVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use OmnibusProVendor\Elasticsearch\Client;
use OmnibusProVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use OmnibusProVendor\Elastic\Elasticsearch\Client as Client8;
/**
