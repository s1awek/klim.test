...
use OmnibusProVendor\Monolog\Formatter\LineFormatter;
use OmnibusProVendor\Monolog\Formatter\FormatterInterface;
use OmnibusProVendor\Monolog\Logger;
use OmnibusProVendor\Monolog\Utils;
use OmnibusProVendor\PhpConsole\Connector;
use OmnibusProVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use OmnibusProVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('OmnibusProVendor\PhpConsole\Connector')) {
