...
namespace WPDesk\Omnibus\Core\Database\Query;

use WPDesk\Omnibus\Core\Database\Query\Expression\CompositeExpression;
use WPDesk\Omnibus\Core\Database\Query\Expression\ExpressionBuilder;
...
class QueryBuilder {
	...
	public function execute_query(): ?array {
	 ...
	 */
	public function setParameter( $key, $value, int $type = ParameterType::STRING ) {
	 ...
	 *
	 * @return array<int, int|string|null>|array<string, int|string|null> The currently defined
	 ...
	 *
	 * @return int|string The value of the bound parameter type
	 */
	 ...
	 * @return $this This QueryBuilder instance.
	 */
	public function addSelect( string ...$selects ) {
		$this->type = self::SELECT;
	 ...
	 * @return $this This QueryBuilder instance.
	 */
	public function groupBy( string ...$groupBys ) {
		if ( count( $groupBys ) === 0 ) {
			return $this;
		}

		return $this->add( 'groupBy', $groupBys, false );
	}
	 ...
	 * @return $this This QueryBuilder instance.
	 */
	public function addGroupBy( string ...$groupBys ) {
		if ( count( $groupBys ) === 0 ) {
			return $this;
		}

		return $this->add( 'groupBy', $groupBys, true );
	}
	...
	public function resetQueryParts( $queryPartNames = null ) {
		$queryPartNames = $queryPartNames ?? array_keys( $this->sqlParts );
	...
	protected function modifyLimitQuery( $query, $limit, $offset ) {
		if ( $limit !== null ) {
