...
<div class="wt_iew_suite_banner">
    ...
    <p style="font-size: 13px; font-weight: 400; margin-top: -61px;margin-left: 13px; padding: 10px 10px;">
        <strong><?php echo esc_html__('💡 Did You Know?', 'product-import-export-for-woo'); ?></strong> <?php echo esc_html__('Get advanced features like FTP/SFTP import, and support for XLSX, XLS, and XML files with our premium version.', 'product-import-export-for-woo'); ?>
