            ...
            <div class="wbte-cta-banner">
                <div class="wbte-cta-content">
                    <div class="wbte-cta-header">
                        <img src="<?php echo esc_url($wt_admin_img_path . '/pdf_invoice.svg'); ?>" alt="<?php esc_attr_e('Product Import Export'); ?>" class="wbte-cta-icon">
                        <h3><?php esc_html_e('WooCommerce PDF Invoices, Packing Slips and Credit Notes'); ?></h3>
                    </div>

                    <ul class="wbte-cta-features">
                        <li><?php esc_html_e('Automatically generate PDF invoices, packing slips, and credit notes'); ?></li>
                        <li><?php esc_html_e('Use ready-made, customizable templates to match your brand'); ?></li>
                        <li><?php esc_html_e('Print or download invoices individually or in bulk'); ?></li>
                        <li><?php esc_html_e('Set custom invoice numbering for better organization'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Customize documents fully with visual or code editors'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Include VAT, GST, ABN, and other tax details'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Add "Pay Now" link on invoices'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Add custom fields to any order document with ease'); ?></li>
                    </ul>
